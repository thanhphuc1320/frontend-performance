...
describe('InvitationService', () => {
  ...
  it('creates an invitation with 7-day expiry and hashed token', async () => {
    ...
    const service = new InvitationService(repo as never, identity as never, email as never);
  ...
  it('rejects invitation to deactivated Store', async () => {
    ...
    const service = new InvitationService(repo as never, makeIdentity() as never, makeEmailDelivery() as never);
  ...
  it('accepts an invitation for an existing user and creates membership', async () => {
    ...
    const service = new InvitationService(repo as never, identity as never, makeEmailDelivery() as never);
